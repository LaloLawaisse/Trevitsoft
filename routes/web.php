...
use App\Http\Controllers\MercadoLibreSalesController;
...
Route::middleware(['setData'])->group(function () {
    ...
    Route::get('/pago', [MercadoLibreSalesController::class, 'showPaymentPage'])->name('pago');
    Route::post('/process_payment', [MercadoLibreSalesController::class, 'processPayment']);
    
    Route::post('/tiendanube/uninstall', [TiendaNubeController::class, 'uninstall']);
    Route::post('/tiendanube/eliminate', [TiendaNubeController::class, 'eliminate']);
    Route::post('/tiendanube/data', [TiendaNubeController::class, 'dataRequest']);
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::post('carga-masiva', [FacturaController::class, 'procesarCargaMasiva'])->name('carga-masiva');
    
    Route::post ('crear-factura-pos', [FacturaController::class, 'crearFacturaPOS']);
    
    Route::get('/afip/tipos-impuestos', [App\Http\Controllers\FacturaController::class, 'obtenerTiposImpuestosAfip']);

    
    Route::post('/mercadolibre/procesar-facturas-arca', [FacturaController::class, 'procesarCargaMasivaMercadoLibre'])
    ->name('mercadolibre.procesar_facturas_arca');
    
    Route::post('/mercadolibre/billing_info', [App\Http\Controllers\MercadoLibreSalesController::class, 'billingInfo'])
    ->name('mercadolibre.billing_info');
    ...
    Route::get('codigoAprobado', [CallbackController::class, 'codigoAprobado'])->name('codigoAprobado');
    Route::post('/renovar-token', [CallbackController::class, 'renovarToken'])->name('renovar-token');
    Route::post('/obtener-ordenes', [CallbackController::class, 'obtenerOrdenes']);
    Route::post('/obtener-ordenes-fecha', [CallbackController::class, 'obtenerOrdenesFecha']);
    
    Route::post('/mercadolibre/import-sales', [MercadoLibreSalesController::class, 'import'])->name('mercadolibre.import_sales');
    
    Route::get('callbackMP', [CallbackController::class, 'callbackMP']);
    Route::get('codigoAprobadoMP', [CallbackController::class, 'codigoAprobadoMP'])->name('codigoAprobadoMP');
    Route::post('/renovar-token-mp', [CallbackController::class, 'renovarTokenMP']);
    Route::post('/obtener-ordenes-mp', [CallbackController::class, 'obtenerOrdenesMP']);
    Route::post('/obtener-ordenes-fecha-mp', [CallbackController::class, 'obtenerOrdenesFechaMP']);
    
    Route::post('/mercadopago/import-sales', [MercadoPagoController::class, 'import'])->name('mercadopago.import_sales');
    Route::post('/mercadopago/obtener-datos-fiscales', [MercadoPagoController::class, 'obtenerDatosFiscales'])
    ->name('mercadopago.datos_fiscales');

    Route::get('/tiendanube/oauth/callback', [TiendaNubeController::class, 'handleCallback'])->name('tiendanube.callback');
    Route::post('/procesar-facturas-tiendanube', [FacturaController::class, 'procesarCargaMasivaMercadoLibre'])->name('tiendanube.procesar_facturas_arca');
    Route::post('/obtener-ordenes-tiendanube', [TiendaNubeController::class, 'obtenerOrdenes']);
    Route::post('/obtener-ordenes-fecha-tiendanube', [TiendaNubeController::class, 'obtenerOrdenesFecha']);
    ...
    Route::post('/sale_pos/generar-factura-pos', [FacturaPosController::class, 'FacturaPos'])->name('generar_factura_pos');
    Route::get('/sale_pos/carga-masiva-pos', [FacturaPosController::class, 'MasivaPos'])->name('carga_masiva_pos');
    
    Route::get('/factura/{id}/proforma', [SellPosController::class, 'proforma'])->name('factura.proforma');
    
    Route::post('/get-taxpayer-details', [SellPosController::class, 'getTaxpayerDetails']) ->name('get.taxpayer.details');
...
Route::get('/planes', [PlanController::class, 'show'])->name('planes');
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone'])->group(function () {
    ...
    // routes/web.php
    Route::get('/preview-invoice/{transaction_id}', [SellPosController::class, 'preview'])->name('sell.preview');
    Route::get('/download-invoice/{transaction_id}', [SellPosController::class, 'download'])->name('sell.download');
    Route::get('/serve-invoice/{transaction_id}', [SellPosController::class, 'serveInvoice'])->name('sell.serve');
