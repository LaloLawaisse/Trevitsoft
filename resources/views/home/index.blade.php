...
@section('content')
    ...
    <!-- Contenedor para centrar y dejar espacio a los lados -->
    <div style="
      ...
      /* Espaciados externos para que no toque los bordes de la pantalla */
      margin-top: 2rem;            /* Separación desde arriba */
      margin-left: 2rem;           /* Separación desde la izquierda */
      margin-right: 2rem;          /* Separación desde la derecha */
      
      /* Ajusta el ancho para que no ocupe todo el contenedor */
      width: 60%;
    ">
