...
<head>
  ...
  <title>Subscripción gestionenorden</title>
          ...
          try {
            ...
            if (data.status === 'success') {
              ...
              if (actionFromUrl === 'nonregister') {
                ...
                if ({{ $amount }} === 25000) {
                  redirectUrl = 'https://gestionenorden.com/business/register?package=1';
                } else if ({{ $amount }} === 50000) {
                  redirectUrl = 'https://gestionenorden.com/business/register?package=2';
                } else if ({{ $amount }} === 75000) {
                  redirectUrl = 'https://gestionenorden.com/business/register?package=3';
                } else if ({{ $amount }} === 144000) {
                  redirectUrl = 'https://gestionenorden.com/business/register?package=5';
                }
              }
