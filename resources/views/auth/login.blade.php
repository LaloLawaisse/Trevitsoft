...
@section('content')
    ...
    @endif
            ...
            <div
                ...
                <div class="tw-flex tw-flex-col tw-gap-4 tw-dw-rounded-box tw-dw-p-6 tw-dw-max-w-md">
                    ...
                    <form method="POST" action="{{ route('login') }}" id="login-form">
                        ...
                        <div class="form-group has-feedback {{ $errors->has('username') ? ' has-error' : '' }}">
                            <label class="tw-dw-form-control">
                                <div class="tw-dw-label">
                                    <span
                                        class="tw-text-xs md:tw-text-sm tw-font-medium tw-text-black">Usuario</span>
                                </div>
                        ...
                        <!-- Línea separadora estética con mayor margen inferior -->
                        <hr class="tw-mt-4 tw-mb-4 tw-border-t tw-border-gray-300">
                        
                        <!-- Botón Registrarme -->
                        <button type="button"
                            onclick="window.location.href='https://gestionenorden.com/pricing';"
        ...
        <div class="col-md-4"></div>
            ...
            <a href="https://api.whatsapp.com/send/?phone=%2B5493573514309text=Hola%21%20Te%20escribo%20por%20asistencia%20con%20la%20pagina%20gestionenorden.&type=phone_number&app_absent=0" target="_blank" title="Escríbenos por WhatsApp">
